...
import com.lautajamdev.peluqueriacanina.persistencia.exceptions.NonexistentEntityException;
...
public class DuenioJpaController implements Serializable {
    ...
    public DuenioJpaController(){
        emf = Persistence.createEntityManagerFactory("com.lautajamdev_PeluqueriaCanina_PU");
    }
